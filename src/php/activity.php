...
?>
<!DOCTYPE html>
<!-- Last Published: Tue Mar 15 2022 12:38:41 GMT+0000 (Coordinated Universal Time) --><html data-wf-page="62230a7f87949d3ae081a6ad" data-wf-site="62230a7f87949d68de81a6a0">
				...
				<div class="div-cont">
					<div class="w-row">
						<div class="w-col w-col-4 w-col-stack">
							<div class="dm">
								<h4 class="hm">Свадьбы</h4>
								<div class="hm text">Собрание, совещание групп лиц,<br> отдельных лиц, организации</div>
							</div>
						</div>
						<div class="w-col w-col-8 w-col-stack">
							<div class="div-block">
								<h4 class="hm">Выездная <br>регистрация</h4>
								<div class="hm text">Собрание, совещание групп лиц, <br>отдельных лиц, организации</div>
							</div>
						</div>
					</div>
					<div class="w-row">
						<div class="w-col w-col-8 w-col-stack">
							<div class="div-block-2">
								<h4 class="hm">Конференции</h4>
								<div class="hm text">Собрание, совещание групп лиц,<br> отдельных лиц, организации</div>
							</div>
						</div>
						<div class="w-col w-col-4 w-col-stack">
							<div class="div-block-3">
								<h4 class="hm">Банкеты <br>и юбилеи</h4>
								<div class="hm text">Собрание, совещание групп лиц,<br> отдельных лиц, организации</div>
							</div>
						</div>
					</div>
					<div class="w-row">
						<div class="w-col w-col-4 w-col-stack">
							<div class="div-block-4">
								<div class="hm text">Собрание, совещание групп лиц,<br> отдельных лиц, организации</div>
								<h4 class="hm">детские<br>праздники</h4>
							</div>
						</div>
						<div class="w-col w-col-8 w-col-stack">
							<div class="div-block-5">
								<div class="hm text">Собрание, совещание групп лиц,<br> отдельных лиц, организации</div>
								<h4 class="hm">корпоративы</h4>
							</div>
						</div>
					</div>
					<div class="w-row">
						<div class="w-col w-col-4 w-col-stack">
							<div class="div-block-6">
								<h4 class="hm">новый год</h4>
								<div class="hm text">Собрание, совещание групп лиц,<br> отдельных лиц, организации</div>
							</div>
						</div>
						<div class="w-col w-col-8 w-col-stack">
							<div class="div-block-7">
								<h4 class="hm">выпускные</h4>
								<div class="hm text">Собрание, совещание групп лиц,<br> отдельных лиц, организации</div>
							</div>
						</div>
					</div>
					<div class="div-block-8">
						<h4 class="heading-2">гендер-пати</h4>
						<div class="text-block-7">Собрание, совещание групп лиц, <br>отдельных лиц, организации</div>
					</div>
				</div>
			</div>
			<?php endwhile; ?>
