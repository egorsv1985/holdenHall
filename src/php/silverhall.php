...
?>
<!DOCTYPE html>
<!-- Last Published: Tue Mar 15 2022 12:38:41 GMT+0000 (Coordinated Universal Time) --><html data-wf-page="62230a7f87949d5ff581a6bc" data-wf-site="62230a7f87949d68de81a6a0">
	<?php get_template_part("header_block", ""); ?>
	<body wp_template_cpt="post" class="body">
...
<input type="submit" value class="search-button w-button"></form>
		...
		<div class="posts wf-section">
			...
			<h1 class="head-zaly sh">Silver Hall</h1>
			<div class="container">
				<div data-delay="4000" data-animation="slide" class="slider-1 sh w-slider" data-autoplay="false" data-easing="ease" data-hide-arrows="false" data-disable-swipe="false" data-autoplay-limit="0" data-nav-spacing="3" data-duration="500" data-infinite="true">
				...
				<div class="w-row">
					<div class="w-col w-col-4"><img src="<?php echo get_template_directory_uri() ?>/images/6229e525b1ab8205397be738_SH1.png" loading="lazy" alt></div>
					<div class="w-col w-col-4"><img src="<?php echo get_template_directory_uri() ?>/images/6229e525f7cdf1407b2ae399_SH2.png" loading="lazy" alt></div>
					<div class="w-col w-col-4"><img src="<?php echo get_template_directory_uri() ?>/images/6229e525b1ab8205397be738_SH1.png" loading="lazy" alt></div>
				</div>
				<div class="rich-text-block w-richtext">
				...
				<div class="w-row">
					<div class="w-col w-col-6"><img src="<?php echo get_template_directory_uri() ?>/images/6229e5e52b1f0df3417f4e6c_Rectangle203401.png" loading="lazy" alt></div>
					<div class="w-col w-col-6"><img src="<?php echo get_template_directory_uri() ?>/images/6229e5e56d295f1ce92d71f6_Rectangle203402.png" loading="lazy" alt></div>
				</div>
				<div class="rich-text-block w-richtext">
					<?php echo get_field('4_abzac') ?>
				</div>
				<div class="w-row">
					<div class="w-col w-col-4"><img src="<?php echo get_template_directory_uri() ?>/images/6229e675200011f53d13e20d_Rectangle203401.png" loading="lazy" alt></div>
					<div class="w-col w-col-8"><img src="<?php echo get_template_directory_uri() ?>/images/6229e6756d295f5a7e2d7662_Rectangle203402.png" loading="lazy" alt></div>
				</div>
				<div class="rich-text-block w-richtext">
