...
?>
<!DOCTYPE html>
<!-- Last Published: Tue Mar 15 2022 12:38:41 GMT+0000 (Coordinated Universal Time) -->
<html data-wf-page="62230a7f87949d1c8581a6a6" data-wf-site="62230a7f87949d68de81a6a0">
...
<body class="body">
						...
						<div data-ix class="nav-link w-dropdown" true>
							...
							<nav class="dropdown-list-7 w-dropdown-list">';
								...
								if ($menu_items[$key]->menu_item_parent == 0) {
									$target = $menu_item->target ? $menu_item->target : '_self';
									$link_class = 'nav-link w-nav-link';
								} else {
									$link_class = 'drop-link w-dropdown-link';
								}
	...
	<div class="home-section wf-section">
		<div class="home-cont w-clearfix">
			...
			<h4 class="main-text">Запишитесь на просмотр залов прямо сейчас</h4><a href="#" class="button w-button">Подать заявку ></a>
		</div>
	</div>
					...
					<div class="w-slide">
						<div class="slider-content">
							<div class="slider-div"><img src="<?php echo get_template_directory_uri() ?>/images/6225b8561d5b31a8ef6ef692_Group205581.svg" loading="lazy" alt class="image-6">
								<h2 class="slider-title">Silver Hall</h2><img src="<?php echo get_template_directory_uri() ?>/images/6225b87b470892893f696d98_Group205580.svg" loading="lazy" alt class="image-7">
							</div>
						</div>
					</div>
					<div class="w-slide">
						<div class="slider-content sl2">
							<div class="slider-div"><img src="<?php echo get_template_directory_uri() ?>/images/6225b8561d5b31a8ef6ef692_Group205581.svg" loading="lazy" alt class="image-6">
								...
								</h2><img src="<?php echo get_template_directory_uri() ?>/images/6225b87b470892893f696d98_Group205580.svg" loading="lazy" alt class="image-7">
							</div>
						</div>
					</div>
					<div class="w-slide">
						<div class="slider-content sl3">
							<div class="slider-div"><img src="<?php echo get_template_directory_uri() ?>/images/6225b8561d5b31a8ef6ef692_Group205581.svg" loading="lazy" alt class="image-6">
								<h2 class="slider-title">Ротонда</h2><img src="<?php echo get_template_directory_uri() ?>/images/6225b87b470892893f696d98_Group205580.svg" loading="lazy" alt class="image-7">
							</div>
						</div>
					</div>
					<div class="w-slide">
						<div class="slider-content sl4">
							<div class="slider-div"><img src="<?php echo get_template_directory_uri() ?>/images/6225b8561d5b31a8ef6ef692_Group205581.svg" loading="lazy" alt class="image-6">
								<h2 class="slider-title">Выездная регистрация</h2><img src="<?php echo get_template_directory_uri() ?>/images/6225b87b470892893f696d98_Group205580.svg" loading="lazy" alt class="image-7">
							</div>
						</div>
					</div>
				</div>
		...
		<div class="services-div">
			<div class="div-block-88">
				<div id="w-node-_7f9d5751-fea2-ba94-a118-262b5aee94c7-8581a6a6" data-w-id="7f9d5751-fea2-ba94-a118-262b5aee94c7" class="card-block flowers">
					...
					<div class="card-text">Наша компания быстро и качественно организует мероприятие на открытом воздухе, а наше белоснежная ротонда не оставит равнодушным даже самое черствое сердце</div><a href="#" class="button-card w-button">Подробнее</a>
				</div>
				...
				<form id="wf-form-Phone" name="wf-form-Phone" data-name="Phone" method="get" class="form-2">
					<div class="contact-row">
						<div class="wrap-contact">
							...
							<input type="text" class="w-input" maxlength="256" name="field-5" data-name="Field 5" placeholder="Имя" id="field-5">
						</div>
						<div class="wrap-contact">
							<label for="field-5" class="contact-label">Ваш телефон*</label>
							<input type="tel" class="w-input" maxlength="256" name="field-5" data-name="Field 5" placeholder="+7-XXX-XXX-XX-XX" id="field-5" required>
						</div>
					</div>
